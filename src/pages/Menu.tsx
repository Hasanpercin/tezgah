...
const Menu = () => {
  ...
  return <div className="min-h-screen">
      {/* Hero Section */}
      <Hero backgroundImage={heroImage} title="Menümüz" subtitle="Taze ve seçkin malzemelerle hazırlanan özel lezzetlerimiz" showButtons={false} />
      ...
      <section className="section-padding bg-white">
        <div className="container-custom">
          ...
          {isLoading ? <div className="flex justify-center py-20">
            ...
            </div> : <MenuCategory categories={menuCategories} />}
