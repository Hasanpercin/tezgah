      ...
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 py-12">
          ...
          <div className="space-y-4">
            <h3 className="text-2xl font-playfair font-semibold">Lezzet Durağı</h3>
            <p className="text-sm opacity-80 max-w-xs">
              Eşsiz lezzetleriyle yıllardır hizmet veren Lezzet Durağı, geleneksel tatları modern sunumlarla buluşturuyor.
            </p>
          ...
          <div className="space-y-4">
            ...
            <ul className="space-y-3">
              <li className="flex items-center space-x-3">
                <MapPin size={16} />
                <span className="text-sm">Lezzet Caddesi, No:123, İstanbul</span>
              </li>
              <li className="flex items-center space-x-3">
                <Phone size={16} />
              ...
              <li className="flex items-center space-x-3">
                <Clock size={16} />
                <span className="text-sm">Her Gün: 11:00 - 23:00</span>
              </li>
            </ul>
          </div>
        ...
        <div className="border-t border-white/20 py-6 text-center text-sm opacity-70">
          <p>&copy; {currentYear} Lezzet Durağı. Tüm Hakları Saklıdır.</p>
        </div>
      </div>
    </footer>
  );
